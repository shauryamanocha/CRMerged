        ...
        auth.signInWithCredential(credential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    ...
                    user.id = auth.getUid();
//                    user.school.put("name",schoolSelect.school)schoolSelect.school;
//                    user.school =(HashMap<String, Object>) new HashMap<String,Object>().put("name",(String)schoolSelect.school);
