    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        schoolSelect.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                schoolSelected = true;
//                googleSignIn.user.school =(HashMap<String, Object>) new HashMap<String,Object>().put("name",school);
                MapsActivity.user.schoolName = school;
                MapsActivity.user.school.put("name",school);
            }
